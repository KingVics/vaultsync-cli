...
secretsCmd
    ...
    try {
        ...
        for (const b of blobs) {
            ...
            console.log(`${b.label.padEnd(24)} ${b.environment.padEnd(16)} ${String(b.version).padEnd(6)} ${created.padEnd(28)} ${b.id}`);
        }
        console.log();
    }
    catch (err) {
